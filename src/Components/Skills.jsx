    ...
    <section id="skills" className="max-w-6xl mx-auto px-6 py-20">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {categories.map(([category, { color, icon }]) => (
          <div
            key={category}
            className="flex items-center gap-4 bg-slate-800/50 border border-slate-700/50 rounded-2xl p-5 shadow-lg transition-all duration-300 hover:shadow-xl hover:border-slate-600"
          >
